...
> 最新日期版原始记录见 `paper_daily_2026-08-05.md`。本文件作为自动化提交流程的兼容入口，保留本次新增论文摘要。
...
## 26. NeurOCNN: A Neural-Operator-Based Model for Physiological Time Series
...
## 27. Cached Foundation Model Summaries for Memory-Efficient Clinical Time Series Inference
